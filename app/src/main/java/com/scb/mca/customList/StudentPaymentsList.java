...
public class StudentPaymentsList extends BaseAdapter {
    Context context;
    ...
    public StudentPaymentsList(Context applicationContext, List<String> name, List<String> description, List<String> date, List<String> price, List<String> docID){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView=layoutInflater.inflate(R.layout.list_student_payment,null);
